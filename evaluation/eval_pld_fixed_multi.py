"""Evaluate PLD decoding on the fixed NewDream/DREAM benchmark manifests."""
...
from method.pld.spec_model_pld import SpecModel  # noqa: E402
...
def build_arg_parser():
    ...
    parser.add_argument("--n-pred", "--n_pred", dest="n_pred", type=int, default=10)
    ...
    parser.add_argument("--output-dir", type=str, default="/mnt/data/wdy/spec_vlm/result/pld_fixed_eval")
    parser.add_argument("--manifest-dir", type=str, default="/mnt/data/wdy/spec_vlm/result/manifests/dream_baseline_seed42")
    parser.add_argument("--run-tag", type=str, default="pld-fixed")

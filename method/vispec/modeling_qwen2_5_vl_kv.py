...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def forward(
        ...
        # Stabilize eager fp16 attention without turning invalid scores into neutral zeros.
        if query_states.dtype == torch.float16:
            finfo = torch.finfo(attn_weights.dtype)
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        # [MODIFIED] Ping: potential bug for causal masking
        if (
            use_cache
            ...
            past_len = past_key_values[0][0].current_length
